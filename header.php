  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li>
          <a href="#" onclick="toggleChat(); return false;" style="color:#FFFFFF; font-weight:bold;">
            <i class="fa fa-comments"></i> <span>Chat with Library AI</span>
          </a>
        </li>

        <!-- Summery Detector Sidebar Button -->
        <li>
          <a href="#" onclick="openSummeryDetector(); return false;" style="color:#FFFFFF; font-weight:bold;">
            <i class="fa fa-lightbulb-o"></i> <span>Summery Detector</span>
          </a>
        </li>
...
<!-- Chatbot Modal -->
<div id="chatModal" style="display:none; position:fixed; bottom:30px; right:30px; width:360px; height:500px; background:#fff; border-radius:10px; box-shadow:0 4px 24px rgba(0,0,0,0.18); border:1px solid #e0e0e0; z-index:9999;">
  <div style="height:38px; background:#007BFF; border-bottom:1px solid #1c16d5ff; border-radius:10px 10px 0 0; display:flex; align-items:center; justify-content:space-between; padding:0 10px;">
    <span style="font-weight:bold; color:#FFFFFF;"><i class="fa fa-comments"></i> Library AI</span>
    <button onclick="toggleChat()" style="background:none; border:none; font-size:22px; color:#888; cursor:pointer; line-height:1;">&times;</button>
  </div>
  <iframe src="AI-Chatbot-with-PHP-and-Gemini-API-main" width="100%" height="462px" frameborder="0" style="border:none; border-radius:0 0 10px 10px;"></iframe>
</div>
...
function openSummeryDetector() {
  window.open('summery_detecter/index.php', '_self');
