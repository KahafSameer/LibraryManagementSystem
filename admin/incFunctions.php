<?php
	...
	*/
		...
		$all_tables = array(
			/* ['table_name' => [table props assoc array] */   
				...
				'Magazines' => array(
					'Caption' => 'Magazines',
					'Description' => '',
					'tableIcon' => 'resources/table_icons/blogs.png',
					'group' => $tg[0],
					'homepageShowCount' => 0
				),
				'Users' => array(
				...
				'Return_Book' => array(
					'Caption' => 'Returned',
					'Description' => '',
					'tableIcon' => 'resources/table_icons/application_side_expand.png',
					'group' => $tg[0],
					'homepageShowCount' => 0
				),
				'Types' => array(
	...
	function makeSafe($string, $is_gpc = true){
		// get_magic_quotes_gpc() is deprecated and removed in PHP 8+, so we skip this check
	...
	function undo_magic_quotes($str){
		// get_magic_quotes_gpc() is removed in PHP 8+, so just return $str unmodified
		return $str;
	}
	########################################################################
	...
	*/
	...
	class Request{
		...
		function Request($var, $filter = false){
			...
			// get_magic_quotes_gpc() is removed in PHP 8+, so no need to strip slashes
